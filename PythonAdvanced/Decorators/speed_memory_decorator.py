...
"""
This is a decorator that will measure the memory and speed of a function

We'll use the decorator to test the perfomance of list generation using four methods:
1. Range function
